...
def prepare_prompts(dataset, model=None):
    ...
    for meme_info in meme_info_all:
        ...
        if 'gpt-4o-meme-caption-only' == model:
            ...
            # inputs_template.append({'image_dir':meme_info['img_dir'], 'prompt':f'Here is the context of the meme: "{about}". First, based the given context, explain the meme to me and read the text in this image. Then, provide details for the following categories: \n Visual Elaboration (focus on the main content): \n Detected Text: \n Meaning of the Meme (briefly): \n Literary Device (category words only): \n Emotion (category words only):'})
        elif 'gpt-4o-figmemes-cot-few-shot-manually-crafted' == model:
        ...
        elif 'gpt-4o-figmemes-OCR-only' == model:
            inputs_template.append({'image_dir':meme_info['img_dir'], 'prompt':'Task: \nYou are going to analyse the literary devices of the OCR text of a meme, and choose suitable literary devices from the given candidates;\n\nLiterary devices: \n**Allusion**: Referencing historical events, figures, symbols, art, literature or pop culture.\n \n**Exaggeration**: Similar to Hyperbole. Use of exaggerated terms for emphasis, including exaggerated visuals (including unrealistic features portraying minorities).\n \n**Irony**: Similar to Sarcasm. Use of words that convey a meaning that is the opposite of its usual meaning/mock someone or something with caustic or bitter use of words.\n  \n**Anthropomorphism**: Similar to Zoomorphism. Attributing human qualities to animals, objects, natural phenomena or abstract concepts or applying animal characteristics to humans in a way that conveys additional meaning. \n \n**Metaphor**: Similar to Simile. Implicit or explicit comparisons between two items or groups, attributing the properties of one thing to another. This category includes dehumanizing metaphors. \n \n**Contrast**: Comparison between two positions/people/objects (usually side-by-side).\n**None**: No literary devices are applied to the meme.\n\nExamples ("|||" are separators):\n1.  ORC: "You are pretty high and far out, are not ya? ||| What kind of kick are you on, son? |||"\nLiterary device: ["none"]\n2. OCR: "US Marine Training Meanwhile in Russia ||| MemeCenter te ||| VIA FUNPICS.ME |||"\nLiterary device: ["contrast"]\n3. OCR: "6 year old: I love reading fantasy books ||| He: (trying to impress her) writes Quran ||| dco |||"\nLiterary device: ["allusion", "irony", "metaphor"]\n\nAnalyse the following OCR:\n"' + 
                                    ocr +'" \n\nFollow the JSON format: \n{\n"literary device": ["word 1", …],\n}'})
        elif 'gpt-4o-figmemes-few-shot-with-example-images' == model:
            inputs_template.append({'image_dir':meme_info['img_dir'], 'prompt':'\nThere are four memes, the first three are examples, and you are going to analyze the fourth meme. \n\nTasks: \n1. Extract the texts on the meme;\n2. Explain the meme from three perspectives: the humor of the meme; how the meme conveys the humor; And, the emotion behind the meme;\n3. Choose suitable literary devices from the given candidates;\n4. Choose suitable emotional words from the given candidates\n\nThe context of the fourth meme: {'+ about +'}\n\nEmotion labels: anger, fear, surprise, sadness, disgust, contempt, happiness, none\n\nLiterary devices: \n**Allusion**: Referencing historical events, figures, symbols, art, literature or pop culture.\n \n**Exaggeration**: Similar to Hyperbole. Use of exaggerated terms for emphasis, including exaggerated visuals (including unrealistic features portraying minorities).\n \n**Irony**: Similar to Sarcasm. Use of words that convey a meaning that is the opposite of its usual meaning/mock someone or something with caustic or bitter use of words.\n  \n**Anthropomorphism**: Similar to Zoomorphism. Attributing human qualities to animals, objects, natural phenomena or abstract concepts or applying animal characteristics to humans in a way that conveys additional meaning. \n \n**Metaphor**: Similar to Simile. Implicit or explicit comparisons between two items or groups, attributing the properties of one thing to another. This category includes dehumanizing metaphors. \n \n**Contrast**: Comparison between two positions/people/objects (usually side-by-side).\n**None**: No literary devices are applied to the meme.\n\nMeme examples:\n1. There is no literary device used in the first meme, so it is "None";\n2. The literary device "Contrast" is used here to compare the rigorous training of US Marines with an older Russian woman;\n3. The literary devices "Anthropomorphism" and  "Exaggeration" are used here to say that Hillary was going to win Trump easily)\n\nNow, based on the fourth meme (image), the context of the fourth meme, the first three examples, the emotion labels, and the definition of literary devices, write down the detected text and explanation of the fourth meme. Then, label the fourth meme with one or multiple appropriate literary devices and emotional words. Follow the JSON format: \n{\n"detected text": "string",\n"explanation": "a string",\n"emotion": "a string",\n"literary device": ["word 1", …],\n"emotion word": ["word 1", …]\n}'})
            # inputs_template.append({'image_dir':meme_info['img_dir'], 'prompt':f'Here is the context of the meme: "{about}". First, based the given context, explain the meme to me and read the text in this image. Then, provide details for the following categories: \n Visual Elaboration (focus on the main content): \n Detected Text: \n Meaning of the Meme (briefly): \n Literary Device (category words only): \n Emotion (category words only):'})
        elif 'gpt-4o-memecap-few-shot-with-example-images' == model:
            inputs_template.append({'image_dir':meme_info['img_dir'], 'prompt':'\nThere are four memes, the first three are examples, and you are going to analyze the fourth meme. \n\nTasks: \n1. Extract the texts on the meme;\n2. Generate visual elaborations and the meaning for the given meme, based on the meme context and the writing style of the given examples.\n\nThe context of the meme: "{' + 
                                    about + '}"\n\nExample 1 (the first meme):\nVisual elaborations: \n1. "Cat is riding a motorcycle",\n2. "A determined cat with its legs spread out while on a motorcycle that is off the ground."\n\nMeaning of the meme: \n1. "Meme poster is saying their cat moves much more quickly to answer them when they call it with a certain sound rather than by its name.",\n2. "The person who wrote the post is saying cats are unpredictable."\n\nExample 2 (the second meme):\nVisual elaborations: \n1. "the different pictures of the man showing his different facial expressions, which includes sadness, disappointment and sorrowful. "\n\nMeaning of the meme: \n1. "Meme poster realizes there\'s always a mass plague in the 20s.",\n2. "The meme poster feels bad after realizing the impact of Plague in 1820 and 1920.",\n3. "Poster realizes plagues occur on the 20th year of every new century"\n\nExample 3 (the second meme):\nVisual elaborations: \n1. "Tom from Tom and Jerry smiles as he shakes the hands of other smiling kittens.\n\nMeaning of the meme: \n1. "Meme poster appreciates their only two followers and one of them is their alternative account.",\n2. "Meme poster uses their alternate account to like their memes.",\n3. "Meme poster exposes that he has only 2 faithful followers.",\n4. "Meme poster is trying to convey that while they don\'t have many followers, they appreciate the people that like his posts."\n\nNow, based on the fourth meme (image), the context of the meme, and the first three examples, write down at most 3 visual elaborations and at most 3 meanings for the fourth meme. Follow the JSON format: \n{\n"detected text": "string",\n"visual elaborations": ["elaboration 1", …],\n"meaning of the meme": ["meaning 1", …]\n}'})
